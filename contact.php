...
if($res)
{
    $_SESSION['status']='Data submited';
    header('location:contact.php');
}
else{
     die ("INSERT Failed:".mysqli_connect_error($con));
}
}
    ...
    <div class="container-xxl py-6">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                ...
                <h1 class="display-6 mb-4">If You Have Any Problem, Please Contact Us</h1>
            </div>
            <div class="row g-0 justify-content-center">
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                    <p class="text-center mb-4">The contact form is there to help you reach us.</p>
                    <form method="POST">
                        <div class="row g-3">
                            <div class="col-md-6">
