...
$sql="INSERT INTO registration (name,email,phonenumber,password) values('$name','$email','$phonenumber','$password')";
...
<body>
    ...
    <div class="container-fluid page-header py-6 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center pt-5 pb-3">
            <h1 class="display-4 text-white animated slideInDown mb-3">Register Here!</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="index.html">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="team.html">Team Page</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="login.php">login</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">Registration form</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-xxl py-6">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 500px;">
                <p class="text-primary text-uppercase mb-2">// Register Here!</p>
                <h1 class="display-6 mb-4">Provide Us correct information about you. </h1>
            </div>
            <div class="row g-0 justify-content-center">
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                    <p class="text-center mb-4">Register Here!>></p>
                    <form method="POST">
                        <div class="row g-3">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating">
                                    <input type="text" class="form-control" name="phonenumber" id="phonenumber" placeholder="Your Email" required>
                                    <label for="number">Your PhoneNumber</label>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-floating">
                            ...
                            <div class="col-12 text-center">
                                <button class="btn btn-primary rounded-pill py-3 px-5" type="submit">Create Account>></button>
                            </div>
                            <div><a href="login.php"> Already Have account!</a></div>
                        </div>
                    </form>
                </div>
            </div>
